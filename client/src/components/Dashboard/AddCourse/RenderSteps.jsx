...
export default function RenderSteps() {
  ...
  return (
    <>
      <div className="relative mb-2 w-full hidden md:flex  ml-16">
        {steps.map((item) => (
          <div className="flex" key={item.id}>
            ...
            {item.id !== steps.length && (
              <>
                <div className={`h-5 w-[150px] border-dashed border-b-2 ${
      ...
      <div className="relative mb-16 hidden md:flex w-full select-none  ml-5 gap-14 ">
        {steps.map((item) => (
