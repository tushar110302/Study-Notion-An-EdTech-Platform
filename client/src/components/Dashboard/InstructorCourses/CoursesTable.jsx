      ...
      <Table className="rounded-xl border border-richblack-800 text-richblack-100">
        <Thead>
          <Tr className="flex gap-x-10 rounded-t-md border-b border-b-richblack-800 px-6 py-2">
            <Th className="flex flex-1 text-left text-sm font-medium uppercase" >
              Courses
            </Th>
        ...
        <Tbody>
          {courses?.length === 0 ? (
            ...
            courses?.map((course) => (
              <Tr key={course._id} className="flex gap-x-10 border-b border-richblack-500 px-6 py-8">
                <Td className="flex flex-1 gap-x-4">
                  <img
                    src={course?.thumbnail}
                    alt={course?.courseName}
                    className="h-[148px] w-[244px] lg:block rounded-lg object-cover"
                  />
